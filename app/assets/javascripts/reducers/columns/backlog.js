...
/**
   - Accepted (ordenando pelo accepted_at)
  - Delivered (ordenando por delivered_at)
  - Rejected (ordenando por position)
  - Finished (ordenando por position)
  - Started (ordenando por started_at)
  - Unstarted (ordenando por position)
